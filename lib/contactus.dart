  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        drawer: SideMenu(currentRoute: '/contact'),
                  ...
                  child:Column(
                    ...
                    children: <Widget>[
                      Container(
                        ...
                        child: Column(
                          children: [
                            Text('للتواصل معنا',style: TextStyle(color: Colors.blue,fontSize: 35,fontWeight: FontWeight.bold),),
                            Text('رأيك يهمنا. تطبيق إروي في تطوير مستمر لذلك رأيك يساهم في تحسين فعالية الري.'),
                            Form(
                              key: formkey,
                              child: Column(
                                children: [
                              ...
                              style: TextStyle(fontFamily: 'OpenSans'),
                                  ...
                                  ElevatedButton(
                                    onPressed: () async {
                                      if (!formkey.currentState!.validate()) { // Use ! to ensure non-null safety
                                        return;
                                      }
                                      setState(() {
                                        isLoading = true;
                                      ...
                                      final user = await sendMessage(Message);
                                    ...
                                    style: ElevatedButton.styleFrom(
                                      backgroundColor: Color(0xff26a69a), // Same color as before
                                    ),
                                    child: Text(
                                      'ارسل اقتراحك',
...
Future<String> sendMessage(  String usersuggestion) async {
  ...
  final http.Response response = await http.post(
    Uri.parse('https://irwicrop.com/Home/Contact'), // Convert String to Uri
    headers: <String, String>{
      'Content-Type': 'application/json; charset=UTF-8',
      'Cookie': cookie,
    },
